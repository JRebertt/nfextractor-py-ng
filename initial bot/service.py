...
def generate_reports(root_directory, user_month, is_detailed=True):
    ...
    for category in categories:
        ...
        if category != "Diversos":
            ...
            with open(output_path, 'w', encoding='utf-8') as output_file:
                process_files_for_month(os.path.join(root_directory, category), output_file, user_month, is_detailed)
        else:
...
# O 'if __name__ == "__main__":' e a função 'main' são removidos pois a execução será controlada pela GUI.
